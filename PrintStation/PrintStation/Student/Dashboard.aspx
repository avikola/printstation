<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="PrintStation.Student.Dashboard" %>
...
<head runat="server">
    ...
    <link href="studentstyle.css?<?php echo time(); ?>" rel="stylesheet" />
                ...
                <div class="cover-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <h1 id="whitetext1" class="cover-heading">Student<span style= "color: #FC622F">Dashboard</span></h1>
                        </div>
                                        ...
                                        <div class="tab-content pillinfo col-lg-6">
                                            ...
                                            <div id="vieworders" class="tab-pane fade">
                                                <h3>Your Print Orders:</h3>
                                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <asp:GridView ID="GridView2" OnRowDataBound="OnRowDataBound" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found" ViewStateMode="Enabled" HeaderStyle-Font-Underline="false" HeaderStyle-ForeColor="Black" HeaderStyle-HorizontalAlign="Center" AllowSorting="True" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True">
                                                                <Columns>
                                            ...
                                            <div id="viewcatorders" class="tab-pane fade">
                                                    ...
                                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                        <ContentTemplate>
                                                        <asp:GridView ID="GridView1" runat="server" HeaderStyle-Font-Underline="false" ShowHeaderWhenEmpty="True" EmptyDataText="No Records Found" HeaderStyle-ForeColor="Black" HeaderStyle-HorizontalAlign="Center" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True">
                                                            <Columns>
                                                                <asp:BoundField DataField="Time" HeaderText="Date" SortExpression="Time" DataFormatString="{0:dd/MM/yyyy}" />
                                                                <asp:BoundField DataField="ProductName" HeaderText="Product" SortExpression="ProductName" />
                                                                <asp:BoundField DataField="ProductPrice" HeaderText="Cost" SortExpression="ProductPrice" />
                                                                <asp:BoundField DataField="ProductQuantity" HeaderText="Quantity" SortExpression="ProductQuantity" />
                                                                <asp:BoundField DataField="Status" HeaderText="Status" SortExpression="Status" />
                                                            </Columns>
                                                            <pagerstyle CssClass="paginationstyler"/>
                                                        </asp:GridView>
                                                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PSConnectionString %>" SelectCommand="SELECT * FROM [Product] WHERE ([RegID] = @RegID) ORDER BY [Time]">
                                                            <SelectParameters>
