<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Account Settings.aspx.cs" Inherits="PrintStation.Faculty.Account_Settings" %>
                            ...
                            <div class="student_dashboard">
                                <div class="container settingspos">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class= "col-md-3 settingsright">
                                            <span class="settingstextright"><%:Session["Fname"]%></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class= "col-md-3 settingsright">
                                            <span class="settingstextright"><%:Session["fdept"]%></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class= "col-md-3 settingsright">
                                            <span class="settingstextright"><%:Session["femail"]%></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class= "col-md-3 settingsright">
                                            <span class="settingstextright"><%:Session["fmobile"]%></span>
                                        </div>
                                    </div>
