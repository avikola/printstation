<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Change Password.aspx.cs" Inherits="PrintStation.Faculty.Change_Password" %>
                        ...
                        <div class="wholedashboard">
                            ...
                            <div class="student_dashboard">
                                    <form id="changepass" runat="server" defaultbutton="Button2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <asp:Button ID="Button1" runat="server" Text="Cancel" CssClass="btn btn-lg loginbutton cancelbutton" PostBackUrl="~/Faculty/Account Settings.aspx" />
                                            </div>
                                            <div class="col-md-4">
                                                <asp:Button ID="Button2" runat="server" Text="Confirm" CssClass="btn btn-lg loginbutton homebutton" OnClick="Button2_Click" ValidationGroup="changepass"/>
                                            </div>
                                        </div>
                                    </form>
                            </div>
